...
def detect():
    filename = r'C:\Users\Ritwik\ocv\frecog\data\Attendance_xlsx\third_year_5sem_IT2.xlsx'
    ...
    face_cascade = cv2.CascadeClassifier(r'C:\Users\Ritwik\ocv\frecog\haarcascade\haarcascade_frontalface_default.xml')
